...
- [ThoughtDAG](https://github.com/chenxiachan/thoughtdag) – Open-source, local-first visual LLM workspace for branching research conversations and documents. Canvases are stored locally and can connect to Ollama or user-configured model endpoints. [Website](https://chenxiachan.github.io/thoughtdag/)
